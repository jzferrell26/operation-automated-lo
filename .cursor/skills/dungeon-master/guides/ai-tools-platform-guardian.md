...
**Guardian:** [`ai-tools/agents/ai-tools-platform-guardian.md`](../../agents/ai-tools-platform-guardian.md)
...
- **Defer key security to security-guardian.** This Guardian identifies what keys are needed; security-guardian designs secure storage.
