...
Verify and extend the pre-researched vulnerability intelligence in the existing Guardian body (`.cursor/agents/security-guardian.md`, 333 lines) with authoritative 2025–2026 sources. The Weapon's guides must trace every factual claim to a source in this folder.

## Search queries to run

Pulled from the brief's REFERENCE MATERIAL and the existing Guardian body:
