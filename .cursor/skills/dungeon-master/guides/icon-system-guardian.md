# icon-system-guardian — Dungeon Master's Guide

The Dungeon Master routing skill's record of when to invoke `icon-system-guardian`. Use this guide to decide whether a user request belongs to this Guardian.

**Guardian:** [`ai-tools/agents/icon-system-guardian.md`](../../agents/icon-system-guardian.md)  
...
- **Plan execution loop:** implementation Guardian → `security-guardian` → `quality-guardian` (standard close-out; `icon-system-guardian` may appear in the implementation slot for icon-related features).
