# Principles: investor-cap-table-guardian
...
The Guardian interprets financial and cap-table mechanics. It does not provide legal advice.
...
This weapon is calibrated for **US Delaware C-Corps**. This is the entity type used by the overwhelming majority of VC-backed startups and the form assumed by Carta, Pulley, the YC SAFE, and NVCA model documents.
