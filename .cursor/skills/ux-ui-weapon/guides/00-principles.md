...
If the folder doesn't cover the question, you update the folder *before* answering. "It's not in the brief" is never a valid answer for this Guardian — extend the brief.
