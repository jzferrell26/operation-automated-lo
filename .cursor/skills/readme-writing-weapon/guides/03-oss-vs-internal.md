...
> Open question: The `templates/monorepo-root-readme.md` template was proposed in the Command Brief but not covered in the shallow research pass. If monorepo READMEs are a frequent use case, open a `normal`-depth loremaster pass on "monorepo README patterns 2026".
