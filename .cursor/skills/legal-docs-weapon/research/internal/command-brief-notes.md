# Command Brief Notes: legal-docs-guardian

Extracted by loremaster from `ai-tools/command-briefs/legal-docs-guardian-command-brief.md`.

## Metadata

- **Guardian name:** `legal-docs-guardian`
- **Weapon name:** `legal-docs-weapon`
...
`legal-docs-guardian` owns the full lifecycle of the five canonical SaaS legal documents:
...
- **Does NOT own:** technical data-protection controls (route to `security-guardian`), database schema decisions for personal-data fields (route to `db-guardian`), commercial contract negotiation strategy beyond the DPA.
...
## Proposed Guides (weapon-forge targets)
...
## Open Questions Carried In (for loremaster to resolve)
