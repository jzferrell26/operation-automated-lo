...
The TS driver reads `notification_flags` and surfaces them in the Guild sidebar as Cursor notifications.
...
Pattern derived from `dms-hand/refs/claude-obsidian-main/skills/wiki-ingest/SKILL.md` (Contradictions section + custom callout vocabulary). Active extension (Artifacts 3 + 4) added per the wiki-guardian Command Brief, "EXPECTED OUTPUT" + Phase 6.
