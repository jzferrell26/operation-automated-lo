...
The canonical path for wiki-guardian invocation is the Guild VS Code extension's TypeScript driver. The driver does the heavy lifting (chunk planning, file walking, hash diff, git pre-computation) and hands wiki-guardian a structured payload to act on.
