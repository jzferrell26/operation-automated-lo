# Alt Ads Platforms Guardian — Dungeon Master's Guide

The Dungeon Master routing skill's record of when to invoke `alt-ads-platforms-guardian`. Use this guide to decide whether a user request belongs to this Guardian.

**Guardian:** [`ai-tools/agents/alt-ads-platforms-guardian.md`](../../agents/alt-ads-platforms-guardian.md)
...
- **Meta Ads / Facebook / Instagram:** No peer Guardian today. Handle inline or flag as out of scope for this Guardian. Do not route to `alt-ads-platforms-guardian`.
- **Google Search Ads / Google Display Network:** No peer Guardian today. Handle inline or flag.
