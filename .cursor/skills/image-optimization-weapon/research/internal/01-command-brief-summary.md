...
- `seo-aeo-guardian` owns LCP measurement/reporting; this Guardian owns image delivery *affecting* LCP
- `icon-system-guardian` owns SVG icons; this Guardian owns raster images only
