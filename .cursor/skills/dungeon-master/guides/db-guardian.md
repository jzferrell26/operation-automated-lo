...
- Explicit handoff lines for any finding that belongs to another Guardian (`library-guardian`, `security-guardian`, `react-guardian`, `ai-platform-guardian`, `quality-guardian`).
