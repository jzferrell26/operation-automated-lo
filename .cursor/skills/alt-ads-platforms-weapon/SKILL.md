...
# alt-ads-platforms Weapon

Arsenal for `alt-ads-platforms-guardian` — the Guild Guild's specialist for paid acquisition across the 10 alternative platforms: LinkedIn, TikTok, Reddit, Microsoft/Bing, X/Twitter, Pinterest, Quora, YouTube (standalone), Spotify Ad Studio, and the podcast advertising ecosystem.
...
- **X/Twitter is the most volatile platform in this weapon's universe.** The X/Twitter guide requires quarterly review. Always flag this to the user. See `guides/06-x-twitter-ads.md`.
...
## Open questions (from loremaster)
...
*Forged by weapon-forge from `command-brief` + `research/`. Part of the Guild AI Tools Factory by [Mario Aldayuz a.k.a @thenotoriousllama](https://github.com/thenotoriousllama).*
