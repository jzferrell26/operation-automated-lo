...
Equips `discord-bot-guardian` to build, review, and audit Discord bots and applications on the 2026 Discord API surface. Read this file first on every invocation, then follow the guide pointer for the specific task.
...
Every code sample, review comment, and recommendation from this weapon must respect:
...
## Open questions (flagged by loremaster)

> **TODO — weapon-forge open questions; resolve before next refresh:**
...
- **Annual review**: Full `normal`-depth loremaster re-run.
- **Quarterly**: Skim `discord.com/developers/docs/change-log` for breaking changes.

---

*Forged by weapon-forge from `ai-tools/command-briefs/discord-bot-guardian-command-brief.md` + `research/research-summary.md`. Part of the Guild Guild curated by [Mario Aldayuz a.k.a @thenotoriousllama](https://github.com/thenotoriousllama).*
