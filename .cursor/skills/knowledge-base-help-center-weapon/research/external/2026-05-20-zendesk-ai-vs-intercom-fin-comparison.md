...
- The "Escalation Rules are mandatory" point directly supports the Guardian's critical directive: "Never configure AI chat-with-docs without a mandatory human-escalation path"
