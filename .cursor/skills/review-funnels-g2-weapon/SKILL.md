...
**Paired Guardian:** `ai-tools/agents/review-funnels-g2-guardian.md`
**Command Brief:** `ai-tools/command-briefs/review-funnels-g2-guardian-command-brief.md`
**Research:** `ai-tools/skills/review-funnels-g2-weapon/research/` (populated 2026-05-20 by loremaster)
...
## Seven actions this Weapon supports
...
*Forged by weapon-forge from `review-funnels-g2-guardian-command-brief.md` and loremaster research (2026-05-20). Part of the Guild AI Tools Factory by [Mario Aldayuz a.k.a @thenotoriousllama](https://github.com/thenotoriousllama).*
