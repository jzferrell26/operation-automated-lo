...
Read `ai-tools/skills/dependency-audit-weapon/SKILL.md` first; it is the master index for this Guardian's arsenal.
...
Route to another Guardian when:
...
- The request involves license compatibility legal advice → legal counsel (outside Guardian scope)
- The request involves Snyk pricing tiers or enterprise feature selection → recommend direct Snyk sales conversation; this Guardian does not adjudicate vendor pricing
