...
This weapon was forged from `ai-tools/command-briefs/readme-writing-guardian-command-brief.md` and the research gathered by `loremaster` in `research/research-summary.md`.
