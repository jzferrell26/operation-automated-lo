...
## What branching-strategy-guardian does
...
## Branch protection (configure in GitHub — route to github-repo-health-guardian)
- Require PR review: 1
...
This example demonstrates the ~80% case. The key insight the Guardian delivers that the team didn't ask for is the feature-flag explanation — teams in this state often don't know that long-lived branches are a scope problem, not a Git problem.
