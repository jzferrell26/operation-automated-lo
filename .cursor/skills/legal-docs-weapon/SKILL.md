...
Every output from this weapon is a **best-effort starting point**, not a compliance certification. The canonical closing line for all outputs is:
...
No exceptions. Including this line is a critical directive for `legal-docs-guardian`.

---

## Refresh triggers

Re-run loremaster at `shallow` tier when any of the following occur:
...
*Paired Guardian: `ai-tools/agents/legal-docs-guardian.md`*
