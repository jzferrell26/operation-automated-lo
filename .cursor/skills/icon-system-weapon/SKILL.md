...
- Icon size and color tokens (ux-ui-guardian owns those)
- General React component architecture (react-guardian)
- SVG sprite build-pipeline tooling at the bundler level (devops-guardian)
- General bundle-optimization strategies beyond icon imports (devops-guardian)
...
*Forged by weapon-forge from `icon-system-guardian-command-brief.md` and `research/`. Part of the Guild AI Tools Factory by [Mario Aldayuz a.k.a @thenotoriousllama](https://github.com/thenotoriousllama).*
