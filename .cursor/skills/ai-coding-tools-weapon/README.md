...
The vibe-coder's AI coding tool advisor. This Weapon equips `ai-coding-tools-guardian` to recommend, compare, configure, and debug AI coding tools across the 2026 ecosystem.
...
```
ai-coding-tools-weapon/
├── SKILL.md                          # Guardian's primary instruction set
├── README.md                         # This file
