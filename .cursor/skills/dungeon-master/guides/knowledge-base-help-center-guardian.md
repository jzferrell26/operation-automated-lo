# knowledge-base-help-center-guardian — Dungeon Master's Guide

The Dungeon Master routing skill's record of when to invoke `knowledge-base-help-center-guardian`. Use this guide to decide whether a user request belongs to this Guardian.

**Guardian:** [`ai-tools/agents/knowledge-base-help-center-guardian.md`](../../agents/knowledge-base-help-center-guardian.md)
...
- The user needs a RAG/embedding pipeline implementation (vector store, chunking, retrieval API) — route to `mind-guardian` after this Guardian specifies the KB export format and chunking inputs.
...
If any of the above is missing, the Guardian will ask one targeted clarifying question before proceeding.
