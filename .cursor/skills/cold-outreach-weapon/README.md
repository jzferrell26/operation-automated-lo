...
Paired with `cold-outreach-guardian` (`ai-tools/agents/cold-outreach-guardian.md`). Command Brief at `ai-tools/command-briefs/cold-outreach-guardian-command-brief.md`. Research grounding from `loremaster` at `research/research-summary.md`.
...
└── research/                         — populated by loremaster; read-only
    ├── research-plan.md
