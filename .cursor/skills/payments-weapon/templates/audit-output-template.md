...
- [ ] `db-guardian` — {{schema, indexes, processed_webhook_events table}}
- [ ] `security-guardian` — {{secret storage, PII handling, RBAC on portal sessions}}
- [ ] `react-guardian` — {{Stripe.js, Elements, EmbeddedCheckout}}
- [ ] `library-guardian` — {{PRD scoping for any new payments feature}}
- [ ] `quality-guardian` — {{post-fix verification}}
...
*Produced by payments-weapon. See `SKILL.md` for methodology.*
