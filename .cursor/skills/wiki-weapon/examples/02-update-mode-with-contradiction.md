...
The TS driver renders this in the Guild sidebar as a Cursor notification.
...
3. Updates `.guild/file-hashes.json` with new hash for `src/auth/session.ts`.
4. Renders the `notification_flag` in the Guild sidebar.
