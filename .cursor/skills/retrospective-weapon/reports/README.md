...
This folder accumulates dated retro output files authored by `retrospective-guardian` during live facilitation cycles.
...
Reports are not created unless the user asks `retrospective-guardian` to write the output to disk. By default, the Guardian delivers the facilitation plan inline.
