...
Phases 1–6 are derived from the wiki-guardian Command Brief's ACTION section. The pattern of "agent writes per-page content, orchestrator reconciles after" is ported from `dms-hand/refs/claude-obsidian-main/agents/wiki-ingest.md`.
