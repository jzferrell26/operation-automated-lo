...
This weapon is paired with `changelog-release-notes-guardian` — the Guild AI Guild's specialist for turning shipped code into communication artifacts that users actually read.
