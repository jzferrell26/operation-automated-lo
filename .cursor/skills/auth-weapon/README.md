...
Paired Weapon for **auth-guardian** — the Guild's authentication implementation authority.

Read `SKILL.md` first. It is the master navigation layer: invocation modes, hard rules, severity rubric, cross-Guardian handoffs, and pointers to the 12 guides, 6 templates, 2 scripts, 3 worked examples, and the research trail.
