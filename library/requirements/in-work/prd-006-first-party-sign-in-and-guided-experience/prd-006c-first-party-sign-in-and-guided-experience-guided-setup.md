...
| 006C-AC-013 | Below 768 px the panel is a bottom sheet capped at 40 percent of the viewport, the anchored field is scrolled into view above it, the sheet never covers the focused field, and the page gains room at its end equal to the sheet's block size so a control anchored at the end of a long page can always be scrolled clear of it (landed by Wave 7r, see Amendments); at 768 the panel anchors beside the element; proven by the 390 and 768 browser specs and by the accessibility walk's pointer-clearance assertion at every step. | 3, 4 |
