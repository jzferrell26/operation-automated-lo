---
source_url: internal://ai-tools/command-briefs/docs-site-guardian-command-brief.md
retrieved_on: 2026-05-20
source_type: internal
authority: official
relevance: critical
topic: scope
weapon: docs-site-weapon
---

# Command Brief Analysis - docs-site-guardian

## Summary

The Command Brief defines docs-site-guardian as the Guild Guild's documentation infrastructure specialist. It owns: platform selection, site architecture, docs-as-code discipline, search, and contributor experience. It explicitly does NOT own: OpenAPI spec enrichment (api-docs-guardian), internal library/ knowledge-base authoring (library-guardian), marketing pages (website-guardian), or Next.js SEO strategy (seo-aeo-guardian).
