...
| Tax engines beyond Stripe Tax | Out of scope v1 | TaxJar, Avalara — separate Guardian if needed. |
| Accounting / GL integration (NetSuite, QuickBooks) | Out of scope | Separate Guardian if needed. |
