...
Guardian declares scope: "Running full audit in **Local clone + gh CLI mode**. I have repo read access via `gh auth login`. Branch protection data will be retrieved via GitHub REST API."
