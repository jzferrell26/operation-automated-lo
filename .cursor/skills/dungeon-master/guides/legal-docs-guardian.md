# Legal Docs Guardian — Dungeon Master's Guide

The Dungeon Master routing skill's record of when to invoke `legal-docs-guardian`. Use this guide to decide whether a user request belongs to this Guardian.

**Guardian:** [`ai-tools/agents/legal-docs-guardian.md`](../../agents/legal-docs-guardian.md)
...
- Do not invoke this Guardian for technical compliance controls; that is `security-guardian`'s domain.
