...
This guide is process-only. No framework-specific content; applies to all website-weapon builds.
...
- [ ] Repo path and recommended downstream Guardians listed

---

## Downstream Guardian recommendations

At the end of the Build Report, recommend:

- `seo-aeo-guardian` (SvelteKit track) — post-build SEO audit
- `security-guardian` — CSP header tightening
- `db-guardian` — schema indexing review
- `quality-guardian` — implementation-vs-PRD verification
