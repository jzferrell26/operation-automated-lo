...
**Authored by:** loremaster on 2026-05-20
**Purpose:** Maps each ACTION step in the Command Brief to the research material that `weapon-forge` needs in order to author the corresponding guide.
...
> *"If the retro surfaces a significant architectural, process, or cultural decision, note it with a pointer to `library-guardian`."*
