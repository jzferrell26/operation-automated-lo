...
This skill is **predominantly autonomous** by design. The Guardian batches clarifying questions at the start, then executes phase by phase with smoke checks and commits.
...
- `guides/03-seo-aeo.md` — Phase 3: delegates to seo-aeo-guardian (SvelteKit track); sitemap coordination with Payload
...
- `research/README.md` — index and pointer to cms-payload-weapon/research/ for Payload-specific deep research
- `research/source-prds/` — the canonical 12-phase guide bundled as source PRDs

---

*Paired Guardian: `.cursor/agents/website-guardian.md`*
