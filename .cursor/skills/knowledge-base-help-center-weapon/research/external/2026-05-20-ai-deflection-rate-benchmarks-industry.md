...
- This source is the canonical benchmark reference for `guides/03-ai-deflection.md` - cite these figures when the Guardian is asked "what deflection rate can we expect?"
- The SaaS benchmark (80% simple, 50% medium) is the most relevant figure for the typical user of this weapon
...
- The low rates for healthcare and legal (2-3% on complex tickets) justify the Guardian's directive about mandatory human escalation paths
