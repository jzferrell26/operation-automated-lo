...
The Guardian reviews against this guide whenever:
...
The Guardian does NOT push Style Dictionary on a product that doesn't have a multi-platform need. It surfaces the option when:
...
- **Build artifacts are generated, not hand-edited** — the Guardian rejects PRs that hand-edit `build/ios/Colors.swift`.
