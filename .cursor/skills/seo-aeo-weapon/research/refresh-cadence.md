...
A Weapon last refreshed 18+ months ago is guaranteed to be citing outdated thresholds somewhere.

## What a 90-day review does

The `seo-aeo-guardian` Guardian (on user trigger "refresh seo-aeo research") walks this checklist:
...
The Guardian activates this protocol on:

- "Refresh the SEO research"
- "Update the seo-aeo-weapon research"
- "Run the 90-day SEO/AEO review"
- "Is the Weapon's research still current?"

## Accountability

Owner: unspecified — the user runs it on cadence. If this Weapon accumulates two consecutive missed reviews (180+ days stale), the Guardian should proactively surface the staleness at the start of any new audit invocation.
