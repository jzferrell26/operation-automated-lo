# AI Coding Tools Guardian — Dungeon Master's Guide

The Dungeon Master routing skill's record of when to invoke `ai-coding-tools-guardian`. Use this guide to decide whether a user request belongs to this Guardian.

**Guardian:** [`ai-tools/agents/ai-coding-tools-guardian.md`](../../agents/ai-coding-tools-guardian.md)
...
If a request mentions Cursor in the context of IDE rules or MCP config, prefer `cursor-ide-guardian`. If it mentions Cursor in the context of "should I use Cursor or Claude Code", this Guardian owns it.
...
If the user asks a specific question without workflow context, the Guardian's five-question intake will surface it.
...
- Cross-links to peer Guardians (cursor-ide-guardian, ai-tools-platform-guardian) where appropriate
