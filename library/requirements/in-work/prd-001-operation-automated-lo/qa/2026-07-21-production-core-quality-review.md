...
- `library/knowledge/private/ai/README.md` and governed UX documents (A/M): document AI provider boundaries and delivered workflow contracts.
- `library/requirements/in-work/prd-001-operation-automated-lo/qa/2026-07-21-production-core-security-audit.md` (A): records the required security close-out with 0 Critical and 0 High findings.
