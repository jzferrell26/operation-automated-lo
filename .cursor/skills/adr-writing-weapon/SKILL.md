...
Do NOT activate for:
- General documentation site architecture → `library-guardian`
- Per-entity code extraction into a wiki → `wiki-guardian`
- Security review of an architectural decision → `security-guardian` (hand off after authoring)
...
The research folder was populated by `loremaster` at normal depth (15 files, 12 external source notes). Key sources:
