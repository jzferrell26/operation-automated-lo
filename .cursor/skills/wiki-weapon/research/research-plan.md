...
claude-obsidian source files (read-only port references), located at `dms-hand/refs/claude-obsidian-main/`:
...
Sibling weapon for style mirroring: `guild/.cursor/skills/library-weapon/`.
