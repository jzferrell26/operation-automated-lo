...
Read `ai-tools/skills/branching-strategy-weapon/SKILL.md` first; it is the master index for this Guardian's arsenal.
...
- **Route protection-ruleset configuration to `github-repo-health-guardian`, not `devops-guardian`.** Why: ruleset configuration is GitHub/GitLab UI/API work, not CI/CD pipeline work. Sending it to the wrong Guardian produces duplicated, potentially conflicting advice.
...
Stop and route to another Guardian when:
