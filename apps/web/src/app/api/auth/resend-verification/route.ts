...
export async function POST(request: Request) {
  ...
  // installed package. It runs the send once the response is committed, so the person is back in
  // the workspace before the provider has answered and the answer cannot change what they read.
