# Social Media Marketing Organic Guardian — Dungeon Master's Guide

The Dungeon Master routing skill's record of when to invoke `social-media-marketing-organic-guardian`. Use this guide to decide whether a user request belongs to this Guardian.

**Guardian:** [`ai-tools/agents/social-media-marketing-organic-guardian.md`](../../agents/social-media-marketing-organic-guardian.md)
...
- The user asks about paid social advertising or paid acquisition — no Guardian owns this yet; flag explicitly and stop
...
If the user hasn't provided their realistic available time per week, the Guardian will ask — this is required before building a calendar.
...
All outputs are terminal deliverables — there is no downstream Guardian in this workflow.
...
- Never recommend AI-generated post content — the Guardian's value proposition depends on this boundary
