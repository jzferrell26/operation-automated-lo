...
## After first SAFE: Guardian investor, $150K at $3M post-money valuation cap

Six months after founding, a guardian investor writes a $150K check on a YC post-money SAFE with a $3M valuation cap, no discount, MFN clause.

- Guardian SAFE ownership at signing: $150K / $3M = **5% post-money** (at conversion).
...
| Guardian SAFE (as-converted) | ~556,000 | ~5% |
...
- Guardian SAFE: Converts at $3M cap price. The $12M pre-money is higher than the cap, so guardian investor gets the benefit of the lower cap price (more shares per dollar than a Series A investor).
...
| Guardian (converted from SAFE) | ~800,000 | ~5% |
