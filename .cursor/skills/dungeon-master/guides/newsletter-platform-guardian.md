# Newsletter Platform Guardian — Dungeon Master's Guide

The Dungeon Master routing skill's record of when to invoke `newsletter-platform-guardian`. Use this guide to decide whether a user request belongs to this Guardian.

**Guardian:** [`ai-tools/agents/newsletter-platform-guardian.md`](../../agents/newsletter-platform-guardian.md)
...
If none of these are provided, the Guardian will ask one targeted clarifying question before proceeding.
