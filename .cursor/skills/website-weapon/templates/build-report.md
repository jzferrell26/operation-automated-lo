...
**Built by:** website-guardian (Cursor IDE Guardian)
...
- `seo-aeo-guardian` (SvelteKit track) — post-build SEO audit and schema validation
- `security-guardian` — CSP header tightening review
- `db-guardian` — schema indexing and query audit
