---
name: knowledge-base-help-center-weapon
...
Opinionated playbook for `knowledge-base-help-center-guardian`. Equips the Guardian to select, set up, architect, and continuously improve customer-facing self-service knowledge bases in 2026.
...
3. Read `guides/02-ai-deflection.md` — the three AI deflection patterns and the hand-off protocol to `mind-guardian`.
...
│   ├── 02-ai-deflection.md                  (3-pattern taxonomy; llms.txt; mind-guardian hand-off)
...
- **Route embedding/RAG pipeline implementation to `mind-guardian`.** The three deflection patterns specify the architecture boundary; `mind-guardian` implements the vector retrieval side. Do not cross that boundary. See `guides/02-ai-deflection.md`.
