# Cold Outreach Guardian — Dungeon Master's Guide

The Dungeon Master routing skill's record of when to invoke `cold-outreach-guardian`. Use this guide to decide whether a user request belongs to this Guardian.

**Guardian:** [`ai-tools/agents/cold-outreach-guardian.md`](../../agents/cold-outreach-guardian.md)
...
- **Inbound SDR workflows or AE discovery call scripts:** different discipline and tooling, no peer Guardian today; handle inline or flag as out of scope.
- **CRM architecture (HubSpot/Salesforce schema, pipeline stages, automation):** route to `db-guardian` for schema; no CRM-specific Guardian today.
...
- **LinkedIn content strategy or paid acquisition:** out of scope; no peer Guardian today.
- **Enterprise SDR team operations at scale (Salesforce sequences, 50+ rep outreach programs):** this Guardian is calibrated for founder-led outreach; flag the mismatch and adjust recommendations accordingly or handle inline.
