...
- **Escalate velocity configuration and sprint ceremony questions.** Why: Jira/Linear setup and sprint ritual design are outside this Guardian's domain; conflating the tool with the technique produces brittle advice.
