...
7. **Final pass** per `guides/13-build-report.md`. Deliver: repo path, Build Report link, recommended downstream Guardians.
...
- **Phase 7/9 → `cms-payload-guardian`:** For Payload Collections design, Blocks field architecture, Lexical-to-HTML strategy, CORS, Live Preview, and type-sharing. Read `cms-payload-weapon/SKILL.md` if the Guardian file is not available.
