...
| Paired Guardian | `ai-tools/agents/dependency-audit-guardian.md` |
| Command Brief | `ai-tools/command-briefs/dependency-audit-guardian-command-brief.md` |

---

*Forged by `weapon-forge` from `dependency-audit-guardian-command-brief.md` and `research/`. Part of the Guild AI Tools Factory by [Mario Aldayuz a.k.a @thenotoriousllama](https://github.com/thenotoriousllama).*
