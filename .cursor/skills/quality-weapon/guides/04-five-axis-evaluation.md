...
The five axes are: **Completeness**, **Correctness**, **Alignment**, **Gaps**, **Detrimental Patterns**. They map roughly onto Google's eight reviewer dimensions (see `research/2026-04-24-google-code-review-standard.md`), compressed for this Guardian's plan-relative scope.
