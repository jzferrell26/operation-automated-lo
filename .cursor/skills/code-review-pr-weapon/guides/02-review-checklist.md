...
**Security (surface to security-guardian if found):**
...
When the Guardian generates a checklist for a specific PR, it should scope the checklist to the file types and concerns visible in the diff:
