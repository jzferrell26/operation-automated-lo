...
- **Stripe Connect** (`destination` charges, `application_fee_amount`, `transfer_data`, marketplace flows). Future `connect-guardian`.
- **Stripe Issuing, Treasury, Capital, Climate.** Not in this Weapon.
- **Stripe Terminal / Tap to Pay / in-person.** Different SDK surface; future Guardian if needed.
