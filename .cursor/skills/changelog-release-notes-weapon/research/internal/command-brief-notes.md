...
relevance: high
topic: guardian-identity-and-scope
---
...
The Command Brief establishes `changelog-release-notes-guardian` as the specialist for public changelogs that drive engagement. The Guardian's domain spans:
