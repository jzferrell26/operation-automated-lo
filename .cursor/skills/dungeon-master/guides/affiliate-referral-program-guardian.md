# Affiliate and Referral Program Guardian — Dungeon Master's Guide

The Dungeon Master routing skill's record of when to invoke `affiliate-referral-program-guardian`. Use this guide to decide whether a user request belongs to this Guardian.

**Guardian:** [`ai-tools/agents/affiliate-referral-program-guardian.md`](../../agents/affiliate-referral-program-guardian.md)
...
Optional (Guardian defaults to industry benchmarks if absent):
