...
Read `ai-tools/skills/discord-bot-weapon/SKILL.md` first; it is the master index for this Guardian's arsenal and contains the critical API facts table for the current Discord platform (May 2026).
...
6. **Hand off** to peer Guardians for out-of-scope concerns:
