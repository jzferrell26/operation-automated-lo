# Dungeon Master Guide — modal-toast-dialog-guardian

The Dungeon Master routing skill's record of when to invoke `modal-toast-dialog-guardian`. Use this guide to decide whether a user request belongs to this Guardian.

**Guardian:** [`ai-tools/agents/modal-toast-dialog-guardian.md`](../../agents/modal-toast-dialog-guardian.md)
...
- The user asks about a notification center / persistent activity tray with session persistence (out of scope for this Guardian; handle inline or forge a new Guardian).
