...
| [PRD-005: Authenticated Review Runtime](requirements/in-work/prd-005-authenticated-review-runtime/prd-005-authenticated-review-runtime-index.md) | In Work | Closes completion review findings C1 through C4: real request authentication, correlation and retry correctness, handoff documentation reconciliation, and deployed qualification. In progress on branch `claude/completion-review-2026-09-19`, unmerged; pull request #67 opened 2026-09-21. |
| [PRD-006: First-Party Sign-In and Guided Experience](requirements/in-work/prd-006-first-party-sign-in-and-guided-experience/prd-006-first-party-sign-in-and-guided-experience-index.md) | In Work | Email and password sign-in with self-serve sign-up, forgot-password, and reset; user language across every page; guided setup on first sign-in with a five-minute ceiling; a 10 of 10 design bar with review, accessibility, and visual regression. Supersedes PRD-005b D4 and reuses the PRD-005b session store. Sequenced after PRD-005 Wave 2. |
