...
In this repo, skills are called **Weapons**. Each Weapon is the procedural arsenal for one Guardian (see [AGENTS.md](./AGENTS.md)). They live in [`.cursor/skills/`](./.cursor/skills/), mirrored to [`.claude/skills/`](./.claude/skills/), and packaged for Cowork in [`.cowork/skills/`](./.cowork/skills/).
...
- [AGENTS.md](./AGENTS.md) — the Guardians that wield these Weapons
