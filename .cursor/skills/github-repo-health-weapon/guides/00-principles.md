...
Every recommendation is phrased as an action the *human* (or a named downstream Guardian) should take. Phrasing: "Recommend enabling auto-delete-head-branches in Settings > General > Pull Requests" — not "I'll enable auto-delete-head-branches."
...
| Domain | This Guardian's scope | Handoff to |
|---|---|---|
