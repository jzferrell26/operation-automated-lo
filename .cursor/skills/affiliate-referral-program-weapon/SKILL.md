---
name: affiliate-referral-program-weapon
...
# Affiliate and Referral Program Weapon

Practitioner arsenal for `affiliate-referral-program-guardian`. Encodes the domain knowledge to select, configure, instrument, and economically validate affiliate and referral programs for SaaS products in 2026.

## When to use this weapon

The Guardian reads this SKILL.md first for every invocation. Then navigates to the specific guide for the task. Common triggers:
...
```text
affiliate-referral-program-weapon/
