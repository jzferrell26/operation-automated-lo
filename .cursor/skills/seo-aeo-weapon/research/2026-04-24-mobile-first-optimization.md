...
- Audit flow: the Guardian tests at 320px and 375px viewports; flags horizontal scroll as Critical; flags sub-44px touch targets as High.
- Cross-reference: `ux-ui-guardian` owns visual hierarchy and brand; this Weapon owns the technical/accessibility floor for mobile.
