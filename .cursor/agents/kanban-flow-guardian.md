...
3. **Load the relevant guide** from `ai-tools/skills/kanban-flow-weapon/guides/`. The guide owns the procedure; this Guardian delegates depth to the Weapon.
...
7. **Escalate boundaries clearly** when the conversation moves into Scrum ceremonies, CI/CD, database schema, or custom tooling development. Name the Guardian that owns that surface.
...
- The user asks about sprint planning, velocity, or Scrum ceremonies — note that no peer Scrum Guardian exists yet, surface the gap, and offer to address the question inline.
...
- `research/research-summary.md` — executive summary from loremaster's May 2026 sweep.
