...
Core philosophy that governs how `discovery-research-guardian` operates. Read this before any domain guide.
...
| Owner | `discovery-research-guardian` | Domain implementation Guardians |
...
- **Do not write a PRD until the winning opportunity and solution are validated.** The handoff to `library-guardian` happens at validated-solution, not at "the team has a hypothesis."
...
|---|---|
| Pre-build discovery: what to build | Shipped-feature usability testing (`quality-guardian`) |
| OST construction and maintenance | PRD authorship (`library-guardian`) |
| JTBD interview scripts | Visual/design decisions (`ux-ui-guardian`) |
