...
Read `.cursor/skills/ux-ui-weapon/SKILL.md` first — it is the master index for this Guardian's arsenal.
...
- **System-level changes escalate to `design-system-guardian`** — a new aesthetic, a library migration, or a major restructure is out of scope; rebuilding from inside this Guardian causes drift.
...
- `examples/review-output-example.md` — a full PR review written in the Guardian's voice
...
*Created by the Legendary Guardian Factory.*
