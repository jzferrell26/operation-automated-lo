# Terminal Bash Guardian — Dungeon Master's Guide

The Dungeon Master routing skill's record of when to invoke `terminal-bash-guardian`. Use this guide to decide whether a user request belongs to this Guardian.

**Guardian:** [`ai-tools/agents/terminal-bash-guardian.md`](../../agents/terminal-bash-guardian.md)
...
- Goal (audit existing config, write a new script, set up tooling, migrate to just) — optional; Guardian will ask if missing
