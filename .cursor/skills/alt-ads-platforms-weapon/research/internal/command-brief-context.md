# Internal Context: alt-ads-platforms-guardian

**Source:** Command Brief at `ai-tools/command-briefs/alt-ads-platforms-guardian-command-brief.md`
**Created:** 2026-05-20
**Author:** loremaster (Phase 1.5)

---

## What this Guardian does

`alt-ads-platforms-guardian` is the Guild Guild's paid acquisition specialist for every platform EXCEPT Meta (Facebook/Instagram) and Google Search Ads. It owns:
...
The Guardian is **opinion-forward**: it will tell you when a channel is wrong for your ICP and why, not just how to run ads on it.
...
| CAPI/conversion tracking for alt platforms | Organic social strategy (→ social-media-marketing-organic-guardian) |
| Channel-fit ICP diagnosis | CRM schema for ad-attributed leads (→ db-guardian) |
| Budget allocation frameworks | GDPR/CCPA pixel compliance audit (→ security-guardian) |
| Creative specs per platform | Cold outbound email (→ cold-outreach-guardian) |
...
## Weapon structure (proposed in Command Brief)

The `alt-ads-platforms-weapon` should produce 13 guides, 4 templates, and worked ICP examples:
...
## Relationship to neighboring Guardians

| Guardian | Relationship |
|---|---|
| `social-media-marketing-organic-guardian` | Complementary - organic posts vs paid campaigns. No overlap; paid campaigns hand off to organic for sustained presence |
| `cold-outreach-guardian` | Complementary - outbound email vs paid inbound acquisition. Different channels, often used together in demand gen motions |
| `security-guardian` | Downstream - GDPR/CCPA compliance of tracking pixels should be audited by security-guardian after CAPI is wired |
| `db-guardian` | Downstream - CRM schema for ad-attributed leads belongs to db-guardian, not this Guardian |

---

## Open questions from Command Brief (for weapon-forge to address)
