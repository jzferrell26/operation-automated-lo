# Discord Bot Guardian — Dungeon Master's Guide

The Dungeon Master routing skill's record of when to invoke `discord-bot-guardian`. Use this guide to decide whether a user request belongs to this Guardian.

**Guardian:** [`ai-tools/agents/discord-bot-guardian.md`](../../agents/discord-bot-guardian.md)
