...
How to go from a repo with only ADRs and PRDs to a complete `library/knowledge/private/` knowledge base. This is the methodology used to produce 68 knowledge docs for `guild-code` from 19 ADRs and 43 PRDs.
