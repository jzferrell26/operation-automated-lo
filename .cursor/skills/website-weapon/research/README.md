...
Payload-specific deep research lives in its own dedicated weapon's research folder:

`.cursor/skills/cms-payload-weapon/research/`

This is populated by `loremaster` (Phase 1.5 of the factory pipeline). The source PRDs in this folder reference Payload high-level architecture; detailed Payload implementation claims should cite `cms-payload-weapon/research/` files.
