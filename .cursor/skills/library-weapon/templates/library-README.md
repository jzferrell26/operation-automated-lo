...
ai_description: |
  ...
  Schema reference: guild-shared/standards/library-schema-v2.md.
...
See [`guild-shared/standards/library-schema-v2.md`](../../guild-shared/standards/library-schema-v2.md) for the full specification.
...
- Brand assets → `guild-shared/brands/`
- Wiki entity pages → `guild-wiki/<repo>/wiki/` (derived, never edit)
- Library mirrors → `guild-wiki/<repo>/library/` (derived, never edit)
