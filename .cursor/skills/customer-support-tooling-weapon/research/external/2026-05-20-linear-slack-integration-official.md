...
Linear's official documentation for the Slack integration. This is the authoritative source for the bi-directional sync capability that the Guardian's `05-integrations.md` guide will specify.
