...
Procedural arsenal for `estimation-guardian`, the Guild AI Guild's authority on software estimation and probabilistic delivery forecasting.
...
Load when `estimation-guardian` is invoked. Typical user phrases:
...
- **Escalate velocity-configuration and sprint-ceremony questions.** Why: Jira/Linear setup and sprint ritual design are outside this Guardian's domain.
