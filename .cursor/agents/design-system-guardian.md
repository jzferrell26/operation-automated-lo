...
- **Produce source of truth, not production code** — this Guardian writes `.md` and `.css` source documents. Wiring them into a live codebase is `ux-ui-guardian`'s job.
