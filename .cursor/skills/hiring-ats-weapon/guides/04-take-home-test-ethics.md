...
Neither should be framed as the "better" option. The Guardian's job is to help the user choose the right format for the role and design it ethically.
...
> TODO: open question -- no published industry benchmark for take-home stipend rates as of 2026 research. The formula above is practitioner judgment. Flag to hiring-ats-guardian that this guidance should be updated when a benchmark source is available.
