...
Core framing principles for `estimation-guardian`. Read this guide before any other.
...
## This Guardian's scope boundary

`estimation-guardian` owns:
...
`estimation-guardian` does NOT own:
...
- Roadmap PRD authorship: `library-guardian`
