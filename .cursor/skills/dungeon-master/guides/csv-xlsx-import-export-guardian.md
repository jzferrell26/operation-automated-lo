# csv-xlsx-import-export Guardian -- Dungeon Master's Guide

The Dungeon Master routing skill's record of when to invoke `csv-xlsx-import-export-guardian`. Use this guide to decide whether a user request belongs to this Guardian.

**Guardian:** [`ai-tools/agents/csv-xlsx-import-export-guardian.md`](../../agents/csv-xlsx-import-export-guardian.md)
...
- The user is setting up a scheduled ETL pipeline from an object storage source -- this Guardian handles interactive imports, not scheduled batch jobs.
...
- Always invoke `security-guardian` after this Guardian finishes and before the upload endpoint ships to production.
- Never route large-file streaming architecture questions to this Guardian without confirming the file size -- files > 500 MB require a background-job pipeline outside this Guardian's scope.
