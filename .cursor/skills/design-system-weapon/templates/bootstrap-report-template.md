...
**Companion Guardian:** `ux-ui-guardian`
...
- Estimated refactor duration (handled by `ux-ui-guardian`): {{weeks}}
}}

## Open questions handed to ux-ui-guardian

- {{any loose ends for the companion Guardian}}
...
- [ ] Companion Guardian stub authored (if not already present) at
