...
This shows how to write an auth architecture doc — the most common domain-level doc pattern. Source: `guild-code/library/knowledge/private/auth/auth-architecture.md`.
...
Guild Code's authentication architecture — Clerk + GitHub OAuth only, mandatory 2FA, and two-layer enforcement.
