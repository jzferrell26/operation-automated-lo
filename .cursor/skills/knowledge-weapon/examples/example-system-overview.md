...
The full version for `guild-code` lives at:
`guild-code/library/knowledge/private/architecture/system-overview.md`
...
Master architecture diagram and component summary for the Vibe by Guild Code platform.
