...
Schema is the canonical contract between wiki-guardian and the Guild VS Code extension's TS driver. Field semantics in [`guides/10-response-payload.md`](../guides/10-response-payload.md). Validation patterns ported from `research/2026-04-29-frontmatter-validation.md` (Zod safeParse).
