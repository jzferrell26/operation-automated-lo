...
**Recommended schema (route to `db-guardian` for full schema design):**
...
Instrument these events for every checklist (route to analytics Guardian for implementation):
