...
An end-to-end walkthrough of a typical `okr-goal-setting-guardian` coaching engagement.
...
2. The Objective rewrite came from the user's own answer to a coaching question, not from the Guardian imposing a new Objective. User ownership increases commitment.
