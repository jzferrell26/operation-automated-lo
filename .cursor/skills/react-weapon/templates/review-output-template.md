...
- [ ] `ux-ui-guardian` — {{if any visual / token findings}}
- [ ] `seo-aeo-guardian` — {{if any Next.js SEO findings}}
- [ ] `security-guardian` — {{if any auth / Server Action / storage findings}}
- [ ] `library-guardian` — {{if refactor big enough to warrant a PRD}}
...
*Produced by react-weapon. See `SKILL.md` for methodology.*
