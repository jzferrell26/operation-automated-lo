...
- The "escalation context loss" anti-pattern directly supports the Guardian's critical directive: "Never configure AI chat-with-docs without a mandatory human-escalation path" - escalation must include context, not just route
