# Retrospective Guardian — Dungeon Master's Guide

The Dungeon Master routing skill's record of when to invoke `retrospective-guardian`. Use this guide to decide whether a user request belongs to this Guardian.

**Guardian:** [`ai-tools/agents/retrospective-guardian.md`](../../agents/retrospective-guardian.md)
...
- **Previous action items** (optional): list of last retro's action items for follow-through review. Guardian will skip the opening review if absent.
