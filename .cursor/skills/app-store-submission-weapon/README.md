...
Operational playbook for `app-store-submission-guardian` — the Guild Guild's specialist for getting iOS and Android apps through App Store and Google Play review in 2025-2026.
...
├── README.md                — this file
├── guides/                  — procedural playbooks per stage
├── examples/                — worked happy-path and edge-case walkthroughs
├── templates/               — fill-in-the-blank reports and checklists
├── reports/                 — per-run submission audit logs
└── research/                — loremaster's sources (read-only)
```
