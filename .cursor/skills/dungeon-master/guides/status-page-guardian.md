# Status Page Guardian — Dungeon Master's Guide

The Dungeon Master routing skill's record of when to invoke `status-page-guardian`. Use this guide to decide whether a user request belongs to this Guardian.

**Guardian:** [`ai-tools/agents/status-page-guardian.md`](../../agents/status-page-guardian.md)
