# Docs Site Guardian: Dungeon Master's Guide

The Dungeon Master routing skill's record of when to invoke `docs-site-guardian`. Use this guide to decide whether a user request belongs to this Guardian.

**Guardian:** [`.cursor/agents/docs-site-guardian.md`](../../agents/docs-site-guardian.md)
