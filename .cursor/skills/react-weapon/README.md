...
Cursor skill that equips **react-guardian** to be the Guild's authority on bleeding-edge React architecture, patterns, and code quality for 2025-2026. Encodes the bulletproof-react architectural pillars, the awesome-react curated ecosystem, and React 19/Compiler idioms into guides, examples, templates, and scanning scripts.
...
- **Does not own:** visual design (ux-ui-guardian), SEO / Next.js metadata (seo-aeo-guardian), security audits (security-guardian), PRD authoring (library-guardian), post-refactor QA (quality-guardian).
