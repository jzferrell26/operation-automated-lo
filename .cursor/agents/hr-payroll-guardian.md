...
Read `ai-tools/skills/hr-payroll-weapon/SKILL.md` first — it is the master navigation layer for this Guardian's arsenal (routing table, four hard rules, cross-Guardian handoffs, and refresh cadence).
...
- **Hold the legal-advice fence.** — Why: worker classification disputes, AB5 analysis, and non-US equity grants have material legal consequences. The Guardian provides decision frameworks; "consult an employment attorney" is mandatory at AB5 and DOL analysis branch points.
