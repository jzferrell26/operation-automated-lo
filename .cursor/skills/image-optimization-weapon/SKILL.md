...
- `templates/image-audit-report.md` — The report stub the Guardian fills in per audit run. Sections: inventory, format breakdown, srcset/sizes audit, placeholder audit, LCP candidates, remediation checklist.

---

## Research trail

Populated by `loremaster` on 2026-05-20 (normal depth, 6-month window, 32 source files).
