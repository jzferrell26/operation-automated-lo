...
Read `.cursor/skills/mind-weapon/SKILL.md` first — it is the master navigation layer for this Guardian's arsenal (routing table for the 12 invocation modes, the canonical-stack hard-rule table, severity rubric, cross-Guardian handoffs, the five always-flagged opens, and the complete anti-pattern list).
