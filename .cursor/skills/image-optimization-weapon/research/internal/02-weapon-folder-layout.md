...
loremaster (Phase 1.5) → **weapon-forge reads this folder** (Phase 2) → guardian-creator (Phase 3) → dm-registrar (Phase 4)

## Expected weapon-forge Output Layout

```
ai-tools/skills/image-optimization-weapon/
├── SKILL.md                          # Primary entrypoint for the Guardian
├── guides/
...
└── research/                         # THIS FOLDER (populated by loremaster)
    ├── research-plan.md
    ├── research-summary.md
    ├── index.md
    ├── internal/
...
- SKILL.md orients the Guardian and points to guides
- Guides are consumed at task-time (Guardian deep-dives into relevant guide)
