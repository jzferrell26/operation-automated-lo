...
- **JavaScript:** 38–45% failure rate → ~55–62% pass rate. (The Guardian body says "57%"; Veracode's blog language places JS at the higher end of risk alongside Python and C#.)
...
- The "JavaScript 57% pass rate" from the Guardian body is preserved as a reasonable approximation but the Weapon should note Veracode's JS-at-the-high-end-of-risk framing so the Guardian does not over-trust the 57% number.
