# Runbook Writing Guardian — Dungeon Master's Guide

The Dungeon Master routing skill's record of when to invoke `runbook-writing-guardian`. Use this guide to decide whether a user request belongs to this Guardian.

**Guardian:** [`ai-tools/agents/runbook-writing-guardian.md`](../../agents/runbook-writing-guardian.md)
...
- The user wants to provision infrastructure or write deployment procedures → `devops-guardian` owns the infrastructure knowledge; this Guardian documents it only after the user confirms the procedure
