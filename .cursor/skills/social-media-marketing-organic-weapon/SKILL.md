...
- **Never recommend AI-generated post content.** The Guardian's entire value proposition is authentic founder voice. AI-generated posts are the exact anti-pattern it exists to replace. See `guides/00-principles.md`.
...
This weapon explicitly ends at these handoff surfaces:

| When this comes up | Handoff |
|---|---|
| Email newsletter setup and growth | `newsletter-platform-guardian` |
| Search-driven content strategy (blog posts, landing pages) | `seo-aeo-guardian` |
| Paid social advertising | No Guardian yet — flag explicitly |
| Community management inside Discord/Slack | Out of scope — flag explicitly |
| Brand/visual design for social assets | `design-system-guardian` or `ux-ui-guardian` |
| Teams > 10 people or dedicated social media roles | Out of scope — flag and recommend agency tooling |

---

*Forged by `weapon-forge` from `social-media-marketing-organic-guardian-command-brief.md` and `research/`. Part of the Guild AI Tools Factory.*
