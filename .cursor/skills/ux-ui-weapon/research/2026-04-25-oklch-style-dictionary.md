...
1. **Why** OKLCH (perceptual uniformity, P3 — articulated for the Guardian's review reasoning).
...
- Should the Guardian review for tokens that drift between modes (light brand vs. dark brand differing in `H`)? Yes — added to guide review checklist as a tightening of the "hold H constant across modes" rule.
