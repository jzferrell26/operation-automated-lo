# Done Checklist for a Forged Weapon

Before handing off to guardian-creator, walk this checklist. Every item should be either "done" or "consciously skipped with a note".
...
- [ ] Each example shows both the input (what the Guardian receives) and the output (what the Guardian produces).
...
- [ ] Final message to the user includes the handoff line naming the weapon path and guardian-creator.
