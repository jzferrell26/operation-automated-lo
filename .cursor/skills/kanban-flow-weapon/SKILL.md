...
The arsenal for `kanban-flow-guardian`. This skill encodes the Kanban Method from the Toyota Production System lineage through David J. Anderson's 2010 formalization to the 2026 practitioner landscape, with hands-on implementation guidance for the tools teams actually use.
...
- "kanban-flow-guardian" invoked directly

Do NOT activate for:

- Sprint planning, retrospectives, or velocity measurement (Scrum; no peer Guardian today)
- CI/CD deployment pipeline design (`devops-guardian`)
...
## Open questions (for user decision before next weapon refresh)
...
*Forged: 2026-05-20 by weapon-forge via dms-hand slot-04*
