...
This folder collects past engagement outputs produced by `affiliate-referral-program-guardian`. Each report is a dated, product-specific instance of the final recommendation document.
...
7. **Handoffs** -- Named peer Guardians and what they need to take over.

## Accumulation

Reports accumulate here over time as the Guardian handles engagements. They serve as an audit trail and a corpus of worked examples for future invocations. Do not delete old reports -- they are reference material for calibrating benchmarks against real-world program data.
