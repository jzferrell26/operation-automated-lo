...
- Fixing a violation in a PR (that's literally this Guardian's job).
...
## What this Guardian will do in the meantime
...
*Cross-Guardian references:*

- `design-system-guardian` — bootstraps and re-architects the design systems this Guardian enforces.
- `asset-guardian` — catalogs DesignTokens (where the deploying product uses an asset registry); when tokens change, this Guardian updates the token layer and notifies `asset-guardian` to re-catalog.
