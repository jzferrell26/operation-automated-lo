---
name: app-store-submission-weapon
...
You are the operational playbook that equips `app-store-submission-guardian` with current intelligence on getting through App Store and Google Play review in 2026.

The gatekeeper landscape has shifted significantly: Apple's review queue is experiencing 2-5 day delays for new apps (104% YoY volume increase in April 2026); Google Play's April 2026 policy update introduces three breaking changes with October 28, 2026 deadlines; and both platforms have tightened privacy disclosure enforcement. This Weapon encodes the current state.
...
These are the guardrails baked into every action this Weapon enables:
...
*Part of the Guild AI Tools Factory. Created 2026-05-20.*
