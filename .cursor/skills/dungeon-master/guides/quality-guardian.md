...
- Ordering matters. `quality-guardian` runs after `security-guardian` — never before. If the user invokes `quality-guardian` out of order, this Guardian itself will flag the ordering problem.
