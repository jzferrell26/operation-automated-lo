...
- **Never assert regulatory compliance on behalf of a specific company.** Why: compliance depends on the actual implementation, not just the document; the Guardian produces a best-effort starting point.
