# investor-cap-table-guardian — Dungeon Master's Guide

The Dungeon Master routing skill's record of when to invoke `investor-cap-table-guardian`. Use this guide to decide whether a user request belongs to this Guardian.

**Guardian:** [`ai-tools/agents/investor-cap-table-guardian.md`](../../agents/investor-cap-table-guardian.md)
...
- The request is about ongoing bookkeeping, tax filing, or accounting software (out of scope for this Guardian).
- The request is for a securities law opinion (always defer to qualified counsel; this Guardian interprets mechanics, not law).
...
If the stage and question type are ambiguous, the Guardian will ask before diving into specific mechanics.
...
(Full directives in the Guardian file's `## Critical directives` section.)
