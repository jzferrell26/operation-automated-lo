# Hiring ATS Guardian: Dungeon Master's Guide

The Dungeon Master routing skill's record of when to invoke `hiring-ats-guardian`. Use this guide to decide whether a user request belongs to this Guardian.

**Guardian:** [`.cursor/agents/hiring-ats-guardian.md`](../../agents/hiring-ats-guardian.md)
