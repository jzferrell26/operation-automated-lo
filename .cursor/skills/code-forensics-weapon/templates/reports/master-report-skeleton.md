...
Eleven specific findings (N+1 queries, sequential inserts, unpaginated lists, single-threaded gunicorn, dungeon master files, circular dependencies, react monolith, no caching, accumulated migrations, missing indexes, no rate limiting).
