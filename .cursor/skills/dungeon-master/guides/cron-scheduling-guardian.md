# cron-scheduling-guardian — Dungeon Master's Guide

The Dungeon Master routing skill's record of when to invoke `cron-scheduling-guardian`. Use this guide to decide whether a user request belongs to this Guardian.

**Guardian:** [`ai-tools/agents/cron-scheduling-guardian.md`](../../agents/cron-scheduling-guardian.md)
...
- Background jobs triggered by queue messages without a fixed schedule — no dedicated Guardian yet; handle inline.
