...
## "Dungeon Master skill" orchestration

When a future dm-skill fans out across guardians for a single operation (e.g., "ship feature X"), the canonical order is:
...
You're fourth-to-last in a canonical ship. Anywhere else in the sequence is an exception and must be documented in the dm-skill invocation.
