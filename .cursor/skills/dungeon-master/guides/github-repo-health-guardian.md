# GitHub Repo Health Guardian — Dungeon Master's Guide

The Dungeon Master routing skill's record of when to invoke `github-repo-health-guardian`. Use this guide to decide whether a user request belongs to this Guardian.

**Guardian:** [`ai-tools/agents/github-repo-health-guardian.md`](../../agents/github-repo-health-guardian.md)
...
- The user wants to fix, modify, or enable specific settings themselves — this Guardian audits; it does not act. Provide the recommendation and the GitHub Settings URL; the human executes.
...
- The repo is GitLab, Bitbucket, or another host — this Guardian's checks are GitHub-specific (GitHub Rulesets, GitHub Actions, GitHub CODEOWNERS enforcement).
...
- Never route "fix branch protection" or "enable auto-delete" requests to this Guardian — it is read-only. Produce the recommendation; the human or a settings-capable tool executes.
