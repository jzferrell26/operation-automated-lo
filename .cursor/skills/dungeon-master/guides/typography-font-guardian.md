# typography-font-guardian — Dungeon Master's Guide

The Dungeon Master routing skill's record of when to invoke `typography-font-guardian`. Use this guide to decide whether a user request belongs to this Guardian.

**Guardian:** [`ai-tools/agents/typography-font-guardian.md`](../../agents/typography-font-guardian.md)
