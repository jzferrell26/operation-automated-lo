...
Owns feature and issue PRDs with sequencing, master-index updates, and intelligent decomposition (responsibilities inherited from the retired `prd-generator` Guardian).
