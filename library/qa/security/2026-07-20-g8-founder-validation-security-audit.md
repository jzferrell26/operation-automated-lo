...
**Scope:** Seven new files under `library/discovery/` plus the security remediation recorded below.
...
- [x] **Payment completion evidence could be underspecified** at `library/discovery/experiments/2026-07-20-founding-cohort-demand.md:23`, `library/discovery/experiments/2026-07-20-founding-cohort-demand.md:74`, and `library/discovery/g8-evidence-register.md:28`. The initial wording called the payment provider authoritative but did not explicitly reject a client-controlled success redirect. The fixed contract requires a signature-verified provider event or authenticated API read-back, idempotent reconciliation, and rejection of browser success redirects.
...
- `library/discovery/g8-evidence-register.md:55-63` prohibits payment-card data, credentials, borrower data, recordings, transcripts, direct identifiers, and customer screenshots in Git.
- `library/discovery/g8-evidence-register.md:35-51` confines per-founder reconciliation to an access-controlled system and uses a pseudonymous evidence identifier plus an opaque payment reference.
- `library/discovery/interview-scripts/2026-07-20-founding-cohort-demand.md:14-15` requires affirmative recording consent and prohibits borrower data, provider credentials, card data, and PII-bearing account screenshots.
- `library/discovery/interview-scripts/2026-07-20-founding-cohort-demand.md:76-83` keeps research notes outside Git and requires PII removal from direct quotes.
...
Changed scope: library/discovery plus this standalone security report only
```
...
| File | Change |
| --- | --- |
| `library/discovery/experiments/2026-07-20-founding-cohort-demand.md` | Requires verified provider evidence, idempotent reconciliation, and rejects browser redirects. |
| `library/discovery/g8-evidence-register.md` | Applies the same verified-source rule to the counting contract. |
