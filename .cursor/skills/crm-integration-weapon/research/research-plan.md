# Research Plan: crm-integration-weapon
...
- **Research model:** grok-4.3 (assigned) / executed by loremaster agent via Perplexity MCP + Firecrawl
...
- Raw search results preserved in agent-tools cache files at `C:\Users\mario\.cursor\projects\c-Users-mario-GitHub-guild-code\agent-tools\`
...
**Coverage gaps (for weapon-forge to verify):**
