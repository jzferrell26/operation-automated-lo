...
- File size exceeds 500 MB -- server-side pipeline with object storage (S3/R2) is required; this Guardian does not own the background-job architecture.
