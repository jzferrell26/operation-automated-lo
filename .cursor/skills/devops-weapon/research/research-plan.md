...
1. Kubernetes manifests in scope? **Resolved: out of scope.** Cloud-platform Guardians and `db-guardian` own runtime topology. devops-guardian stops at "image built and pushed".
