...
This weapon encodes five bodies of knowledge:
...
|---|---|
| README exceeds 2,000 words | `library-guardian` for docs-site architecture |
| Code entity documentation needed | `wiki-guardian` |
| CI badge pipeline needs wiring | `devops-guardian` |
| Python ecosystem `.rst` README | `python-guardian` |
| README is for a Ruby gem (Ankane-style) | `ce-ankane-readme-writer` subagent |
...
└── research/                        (DO NOT MODIFY — authored by loremaster)
    ├── research-plan.md
    ├── research-summary.md
    ├── index.md
    └── external/
...
*Forged by `weapon-forge` from `readme-writing-guardian-command-brief.md` and `research/`. Part of the Guild AI Tools Factory by [Mario Aldayuz a.k.a @thenotoriousllama](https://github.com/thenotoriousllama).*
