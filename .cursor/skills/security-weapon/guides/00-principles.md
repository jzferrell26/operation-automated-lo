...
**Out of scope (delegate to another Guardian):**
...
1. **Fix, don't just flag.** Critical and High are remediated in-session. A report that says "found but didn't fix" defeats the Guardian's purpose.
