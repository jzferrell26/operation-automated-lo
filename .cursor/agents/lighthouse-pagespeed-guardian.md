...
7. **Produce an actionable audit report** with prioritized findings, metric impact estimates, and next steps mapped to responsible Guardians. Use the `reports/README.md` template.
