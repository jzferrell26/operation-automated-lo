...
- The framework's key insight - that documentation fails when it mixes modes - gives the Guardian its first and most important diagnostic step: classify before critiquing.
- The "light-weight, doesn't impose constraints" framing is important: the Weapon should present Diataxis as a lens, not a bureaucratic checklist.
