---
name: incorporation-startup-stack-weapon
...
# Incorporation & Startup Stack Weapon

Decision toolkit for `incorporation-startup-stack-guardian`. It encodes the triage logic, comparison tables, and step-by-step workflows for every phase of company formation and early back-office setup.
...
- `templates/formation-decision-report.md` — Saved artifact the Guardian fills in per engagement.
...
*Forged by `weapon-forge` from `command-briefs/incorporation-startup-stack-guardian-command-brief.md` and `research/`. Part of the Guild AI Tools Factory.*
