# live-chat-support-guardian — Dungeon Master's Guide

The Dungeon Master routing skill's record of when to invoke `live-chat-support-guardian`. Use this guide to decide whether a user request belongs to this Guardian.

**Guardian:** [`ai-tools/agents/live-chat-support-guardian.md`](../../agents/live-chat-support-guardian.md)  
...
If platform and tech stack are unknown, the Guardian will ask before producing integration code.
...
- Never allow a client-only HMAC or JWT snippet — this Guardian will always produce a server-side signing function first.
- Always receive a human-fallback rule for AI deflection — the Guardian will refuse to produce a bot-only config.
