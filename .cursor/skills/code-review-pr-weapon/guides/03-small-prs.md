...
**Trunk-based checklist for the Guardian:**
...
## How the Guardian flags a large PR

When a PR exceeds a threshold, the Guardian's output is:
...
The Guardian never blocks the PR based on size alone. It flags the risk and proposes splits. The human decides.
