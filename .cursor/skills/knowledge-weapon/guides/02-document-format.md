...
Guild Code's authentication and authorization architecture — provider, session model, and enforcement layers.
...
## Auth flow (GitHub OAuth → Clerk → Guild)              ← Sequence diagrams get their own section
