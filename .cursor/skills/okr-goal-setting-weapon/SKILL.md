...
Invoke `okr-goal-setting-guardian` when the user needs to:
...
- Engineering roadmap or sprint planning (`agile-scrum-guardian` owns Scrum; domain Guardians own implementation)
...
└── research/                         (owned by loremaster — read-only)
    ├── research-plan.md
    ├── research-summary.md
    ├── index.md
    ├── internal/
...
*Forged by `weapon-forge` from `okr-goal-setting-guardian-command-brief.md` and `research/`. Part of the Guild AI Tools Factory by [Mario Aldayuz a.k.a @thenotoriousllama](https://github.com/thenotoriousllama).*
