...
Opinionated playbook for `docs-site-guardian`. Equips the Guardian to select, set up, and maintain developer-facing documentation sites in 2026.
...
- **Route OpenAPI concerns to `api-docs-guardian`.** Docs-site-guardian wires the reference section into the site but does not author OpenAPI specs or SDK generation.
