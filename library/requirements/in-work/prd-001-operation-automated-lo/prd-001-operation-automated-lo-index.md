...
- Founding paid ads require Meta Housing Special Ad Category. The product owner accepted this known housing and mortgage requirement on 2026-08-25; App Test discovery of alternate category combinations is not a launch gate.
...
12. Run a small private beta within the permitted distribution boundary and measure activation, support time, campaign publication, lead-path success, model cost, and recurring intent.
13. Pursue public Marketplace review only if separately authorized. G1's accepted constraint means Marketplace listing is not a founding launch prerequisite. Preserve PRD-002 as potential future work until the founding product gates pass.
...
1. G2: Direct and agency installation, location-token exchange, signed context, refresh, uninstall, reconnect, and iframe fallback pass in HighLevel App Test.
2. G1: `ACCEPTED CONSTRAINT` as of 2026-08-25. External Marketplace distribution proof and the post-five-agency path are not launch prerequisites. Do not claim a public Marketplace listing without separate authorization.
3. G3: Meta draft, read-back, explicit publish, progress, pause, resume, rejection, uncertain-write reconciliation, and reporting pass with test assets and no uncontrolled spend.
4. G4: `ACCEPTED CONSTRAINT` as of 2026-08-25. Housing Special Ad Category requirements are known and enforced in product. App Test discovery of category combinations is not a launch prerequisite.
5. G5: A no-spend Meta test lead proves form mapping, GHL contact, opportunity, assignment, workflow, notification, and attribution behavior.
6. G6: Stripe-hosted external billing and HighLevel install authorization pass success, failure, cancellation, duplicate, delayed, bulk, uninstall, and reinstall cases.
7. G7: Counsel and lender compliance approve the operating model, disclosures, consent, RESPA, Regulation Z, fair-lending, retention, privacy, and communication rules.
