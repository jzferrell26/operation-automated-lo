# Knowledge Guardian: Dungeon Master's Guide

The Dungeon Master routing skill's record of when to invoke `knowledge-guardian`. Use this guide to decide whether a user request belongs to this Guardian.

**Guardian:** [`.cursor/agents/knowledge-guardian.md`](../../agents/knowledge-guardian.md)
