# api-docs-guardian — Dungeon Master's Guide

The Dungeon Master routing skill's record of when to invoke `api-docs-guardian`. Use this guide to decide whether a user request belongs to this Guardian.

**Guardian:** [`ai-tools/agents/api-docs-guardian.md`](../../agents/api-docs-guardian.md)
...
- The user wants to set up the CI/CD pipeline architecture for docs hosting (beyond the workflow file template this Guardian provides) — route to `devops-guardian`.
