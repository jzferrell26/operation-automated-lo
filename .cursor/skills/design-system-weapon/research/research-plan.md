# Research Plan — design-system-weapon
...
questions used to forge the `design-system-weapon` Cursor skill. It is the
...
## Open questions the Weapon must answer

1. **Tailwind bridge.** Should the Guardian emit a starter `@theme` block so tokens
...
This is the structure the Guardian reproduces. Every guide in the Weapon either
