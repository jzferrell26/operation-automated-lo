...
- **Route platform-selection questions to `docs-site-guardian`.** Why: this Guardian owns the pipeline, not the platform; once the platform is decided, `docs-site-guardian` hands off and this Guardian picks up the highlighting and plugin configuration.
