...
The Guild may want a dedicated **TanStack ecosystem Guardian** later (Query + Router + Table + Form + Start). Flagged in `research/research-plan.md` for a future brief.
