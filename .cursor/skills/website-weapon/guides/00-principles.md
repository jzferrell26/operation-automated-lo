...
This Weapon builds a **SvelteKit (Svelte 5) + Payload CMS + Supabase + Vercel** website.
...
At input time, the Guardian selects one of two modes. This choice affects Phases 1, 7, and 9.
