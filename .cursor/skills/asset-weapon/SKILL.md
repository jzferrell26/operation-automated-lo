...
Cursor-skill wrapper for the `asset-guardian` Guardian's companion resource bundle. The full directory map, intent-routing tables, per-asset guide index, schema picker, examples catalog, templates list, and self-operation notes are in [`README.md`](README.md) — start there.

> **Agent entry point:** [`guild/.cursor/agents/asset-guardian.md`](../../agents/asset-guardian.md)
>
> **Peer Guardians:** [`library-guardian`](../../agents/library-guardian.md), [`quality-guardian`](../../agents/quality-guardian.md), [`security-guardian`](../../agents/security-guardian.md), [`ux-ui-guardian`](../../agents/ux-ui-guardian.md). Scope boundaries are documented in [`guides/05-hand-offs.md`](guides/05-hand-offs.md).
