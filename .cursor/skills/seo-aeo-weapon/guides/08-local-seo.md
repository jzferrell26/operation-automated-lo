...
External directory audit is out of scope for this Weapon (marketing ops territory) — the Guardian flags the need; execution is elsewhere.
...
The GBP listing — free, managed at https://business.google.com — is the single biggest local-SEO lever. The Weapon does **not** manage GBP; it flags:
...
GBP is a marketing-ops concern. The Guardian's job is to ensure the website is ready to benefit from GBP; managing GBP itself is out of scope.
